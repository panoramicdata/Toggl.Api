...
Write-Information "Running all tests..."
Write-Information "Output will be saved to TestOutput.txt"
Write-Information ""
...
Write-Information ""
Write-Information "Test run complete. Results saved to TestOutput.txt"
Write-Information ""
Write-Information "Note: 402 and 429 errors are expected due to Toggl API rate limiting and should be ignored."
